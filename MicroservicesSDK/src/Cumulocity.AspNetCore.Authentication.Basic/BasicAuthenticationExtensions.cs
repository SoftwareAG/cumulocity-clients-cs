...
namespace Cumulocity.AspNetCore.Authentication.Basic
{
    ...
    {
        public static AuthenticationBuilder AddBasicAuthentication(this AuthenticationBuilder builder, Func<(string username, string password), Task<BasicAuthenticationResult>> verify)
            => builder.AddBasicAuthentication(BasicAuthenticationDefaults.AuthenticationScheme, _ => { }, verify: verify);

        public static AuthenticationBuilder AddBasicAuthentication(this AuthenticationBuilder builder, Action<BasicAuthenticationOptions> configureOptions, Func<(string username, string password), Task<BasicAuthenticationResult>> verify)
            => builder.AddBasicAuthentication(BasicAuthenticationDefaults.AuthenticationScheme, configureOptions, verify: verify);

        public static AuthenticationBuilder AddBasicAuthentication(this AuthenticationBuilder builder, string authenticationScheme, Action<BasicAuthenticationOptions> configureOptions, Func<(string username, string password), Task<BasicAuthenticationResult>> verify)
        ...
        public static AuthenticationBuilder AddBasicAuthentication(this AuthenticationBuilder builder, string authenticationScheme, string displayName, Action<BasicAuthenticationOptions> configureOptions, Func<(string username, string password), Task<BasicAuthenticationResult>> verify)
        {
